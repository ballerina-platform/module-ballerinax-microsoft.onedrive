...
public function main() returns error? {
    ...
    log:printInfo("Get sharable link for drive item from item path");
    ...
    onedrive:Permission|onedrive:Error permission = driveClient->getSharableLinkFromPath(itemPath, options);
